...
Y_0 = [0.01,0.01, 0.01, 0.01, 0.01, 0.01,0.01, 0.01, 0.01, 0.01]
X_0 = [0.01,0.01, 0.01, 0.01, 0.01, 0.01,0.01, 0.01, 0.01, 0.01]
...
for round in range(300):
	...
	trjs_Sp = my_sim.PreSamp(trjs, myn_clusters = 20, starting_n = N)
